#' Kestrel nesting data in which each observation is a single chick.
#'
#' 
#' @format A tibble with 2027 rows and 8 variables:
#' \describe{
...
#'   \item{fledge_date}{Date on which the chick turned 30 days old, assumed to be when it fledged}
...
#' }
#' @source \item{Kestrel data collected by Steve Eisenhauer.}
"bychick"